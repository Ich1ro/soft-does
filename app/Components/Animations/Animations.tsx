...
interface AnimationProps {
  children: ReactNode;
  variant?: 'slide-bottom' | 'slide-top' | 'fade-in' | 'slide-left' | 'slide-right';
  delay?: number;
  className?: string;
}

const Animation: React.FC<AnimationProps> = ({ children, variant = 'slide-bottom', delay = 300, className }) => {
